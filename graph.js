...
graph.addVertex('33', {
  ‘35’: weight(data.features[32].geometry["coordinates"], data.features[35].geometry["coordinates"]),
  ‘34’: weight(data.features[32].geometry["coordinates"], data.features[34].geometry["coordinates"]),
  ‘32’: weight(data.features[32].geometry["coordinates"], data.features[32].geometry["coordinates"])
});
graph.addVertex('34', {
